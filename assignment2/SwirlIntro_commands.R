...
ls() #listing the variables
rm(list=ls()) #removing varaibles
...
#To install swirl modules
install_course_zip("C:/Users/sree/Downloads/swirl_courses-master (2).zip", multi=TRUE, which_course="R Programming,R Programming Alt, Data Analysis, Mathematical Biostatistics Boot Camp, Open Intro")
